...
namespace SpyStore.Service.Tests.TestClasses
{
    ...
    public class SearchControllerTests : BaseTestClass
    {
        ...
        {
            //Search Products: http://localhost:7940/api/search/{searchString} 
            // Note: encode spaces with % 20
            //http://localhost:7940/api/search/persuade%20anyone
        ...
        {
            //Get Products with Category Name: http://localhost:7940/api/search/persuade%20anyone
            using (var client = new HttpClient())
            {
