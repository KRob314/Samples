...
namespace SpyStore.Mvc.Controllers
{
    ...
    public class CartController : BaseController
    {
        ...
        private readonly MapperConfiguration _config = null;
        ...
        public async Task<IActionResult> AddToCart( int productId, bool cameFromProducts = false)
        {
            ...
            await _serviceWrapper.GetOneProductAsync(productId);
        ...
        {
            var orderId = await _serviceWrapper
            .PurchaseAsync(ViewBag.CustomerId, customer);
