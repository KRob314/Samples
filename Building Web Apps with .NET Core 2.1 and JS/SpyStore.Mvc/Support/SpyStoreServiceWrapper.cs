...
namespace SpyStore.Mvc.Support
{
    public class SpyStoreServiceWrapper : ISpyStoreServiceWrapper
    {
        ...
        {
            var response = await _client.GetAsync($"{_settings.CartBaseUri}/{customerId}");
        ...
        public async Task<IList<CartRecordWithProductInfo>> GetCartRecordsAsync(int id)
        {
            ...
            .GetAsync($"{_settings.CartRecordBaseUri}/{id}");
            response.EnsureSuccessStatusCode();
            var result = await response.Content
            .ReadAsAsync<IList<CartRecordWithProductInfo>>();
            return result;
        }
        ...
        {
            var response = await _client
            .GetAsync($"{_settings.CategoryBaseUri}/{id}");
            response.EnsureSuccessStatusCode();
        ...
        {
            var response = await _client
            .GetAsync($"{_settings.CustomerBaseUri}/{customerId}");
            response.EnsureSuccessStatusCode();
        ...
        {
            var response = await _client
            .GetAsync($"{_settings.ProductBaseUri}/{productId}");
            response.EnsureSuccessStatusCode();
        ...
        {
            var response = await _client
            .GetAsync($"{_settings.OrderDetailsBaseUri}/{orderId}");
            response.EnsureSuccessStatusCode();
            var result = await response.Content
            .ReadAsAsync<OrderWithDetailsAndProductInfo>();
            return result;
        }
        ...
        {
            var response = await _client
            .GetAsync($"{_settings.OrdersBaseUri}/{customerId}");
            response.EnsureSuccessStatusCode();
        ...
        public async Task<IList<ProductViewModel>> GetProductsForACategoryAsync(int categoryId)
        {
            ...
            $"{_settings.CategoryBaseUri}/{categoryId}/products");
            response.EnsureSuccessStatusCode();
            var result = await response.Content
            .ReadAsAsync<IList<ProductViewModel>>();
            return result;
        ...
        {
            var response = await _client.
            GetAsync($"{_settings.SearchBaseUri}/{searchTerm}");
            response.EnsureSuccessStatusCode();
            var result = await response.Content
            .ReadAsAsync<IList<ProductViewModel>>();
            return result;
        ...
        public async Task<CartRecordWithProductInfo> UpdateShoppingCartRecordAsync(int recordId, ShoppingCartRecord item)
        {
            ...
            return await updatedResponse
            .Content
            .ReadAsAsync<CartRecordWithProductInfo>();
        }
