...
namespace SpyStore.Dal.Repos
{
    public class ShoppingCartRepo : RepoBase<ShoppingCartRecord>, IShoppingCartRepo
    {
        ...
        public ShoppingCartRepo(StoreContext context, IProductRepo productRepo,
        ...
        {
            return Context.CartRecordWithProductInfos.FirstOrDefault(x => x.Id == id);
        }
        ...
        public int Update( ShoppingCartRecord entity, Product product, bool persist = true)
        {
            ...
            dbRecord.TimeStamp.SequenceEqual(entity.TimeStamp))
            {
