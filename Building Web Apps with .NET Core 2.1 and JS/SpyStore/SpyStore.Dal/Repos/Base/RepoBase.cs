    ...
    public abstract class RepoBase<T> : IRepo<T> where T : EntityBase, new()
    {
        ...
        public int SaveChanges()
        {
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                throw new SpyStoreConcurrencyException(
            ...
            catch (RetryLimitExceededException ex)
            {
                ...
                //Should log and handle intelligently
                throw new SpyStoreRetryLimitExceededException(
                "There is a problem with you connection.", ex);
            }
            catch (DbUpdateException ex)
            {
                ...
                if (ex.InnerException is SqlException sqlException)
                {
                    ...
                    {
                        if (sqlException.Message.Contains(
                        "table \"Store.Products\", column 'Id'",
                        ...
                        if (sqlException.Message.Contains(
                        "table \"Store.Customers\", column 'Id'",
                        StringComparison.OrdinalIgnoreCase))
                        {
                            throw new SpyStoreInvalidCustomerException(
                            $"Invalid Customer Id\r\n{ex.Message}", ex);
                        }
                    }
                }
                throw new SpyStoreException(
