...
dotnet new classlib -n SpyStore.Dal -o .\SpyStore.Dal -f netcoreapp2.2
dotnet sln SpyStore.sln add SpyStore.Dal

rem create the class library for the Models and add it to the solution
dotnet new classlib -n SpyStore.Models -o .\SpyStore.Models -f netcoreapp2.2
...
dotnet new xunit -n SpyStore.Dal.Tests -o .\SpyStore.Dal.Tests -f netcoreapp2.2
dotnet sln SpyStore.sln add SpyStore.Dal.Tests

rem create the XUnit project for the Service and add it to the solution
dotnet new xunit -n SpyStore.Service.Tests -o .\SpyStore.Service.Tests -f netcoreapp2.2
...
dotnet new webapi -n SpyStore.Service -au none --no-https -o .\SpyStore.Service -f netcoreapp2.2
...
dotnet new mvc -n SpyStore.Mvc -au none --no-https -o .\SpyStore.Mvc -f netcoreapp2.2
