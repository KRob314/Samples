...
namespace SpyStore.Service.Tests.TestClasses
{
    ...
    public class CategoryControllerTests : BaseTestClass
    {
        ...
        {
            //Get All Categories: http://localhost:7940/api/category
        ...
        {
            //Get One Category: http://localhost:7940/api/category/1
            using (var client = new HttpClient())
            {
        ...
        {
            //Get One Category: http://localhost:7940/api/category/0
            using (var client = new HttpClient())
            {
        ...
        {
            //Get Products For Category: http://localhost:7940/api/category/{id}/products
            using (var client = new HttpClient())
            {
