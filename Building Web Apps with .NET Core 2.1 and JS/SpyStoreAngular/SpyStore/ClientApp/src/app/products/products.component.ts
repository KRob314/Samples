...
export class ProductsComponent implements OnInit
{
  ...
  constructor(private _route: ActivatedRoute, private _service: ProductService, private _loggingService: LoggingService) { }

  ngOnInit()
  {
    // Handles regular url route params
    this._route.params.subscribe(params =>
    {
      if ("categoryId" in params)
      {
        ...
        this._service.getCategory(categoryId).subscribe(category =>
          ...
          err => this._loggingService.logError("Error Loading Category", err));
