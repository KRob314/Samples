...
namespace CinemaGames.Web.Infrastructure.Extensions
{
    public static class EntitiesExtensions
    {
        public static void UpdateMovieSubmission(this MovieSubmission movieSubmission, MovieSubmissionViewModel viewModel)
        {
            movieSubmission.Title = viewModel.Title;
            movieSubmission.MatchId = viewModel.MatchId;
            movieSubmission.PlayerId = viewModel.PlayerId;
            movieSubmission.ReasonToChoose = viewModel.ReasonToChoose;
            movieSubmission.SubmissionDate = viewModel.SubmissionDate;
            movieSubmission.Synopsis = viewModel.Synopsis;
            movieSubmission.Trailer = viewModel.Trailer;
        }
